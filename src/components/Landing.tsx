        ...
        <div className="max-w-6xl w-full">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-gray-600">Loading showcase guitar...</p>
            </div>
          ) : guitar ? (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="grid md:grid-cols-2 gap-0">
                  {/* Image */}
                  <div className="relative bg-gray-100 aspect-square md:aspect-auto min-h-[400px]">
                    {imageUrl ? (
                      <img
                        src={imageUrl}
                  ...
                  <div className="p-8 lg:p-12 flex flex-col justify-center space-y-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-xl text-gray-900">{guitar.type}</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-xl text-gray-900">{guitar.color}</p>
                      </div>
                      ...
                      {guitar.finish && (
                        <div>
                          ...
                          <p className="text-xl text-gray-900">{guitar.finish}</p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="border-t border-gray-200 pt-6 space-y-3">
                      ...
                      {guitar.bodyMaterial && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-gray-900">{guitar.bodyMaterial}</span>
                        </div>
                      )}

                      {guitar.neckMaterial && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Neck Material</span>
                          <span className="font-medium text-gray-900">{guitar.neckMaterial}</span>
                        </div>
                      )}
                      ...
                      {guitar.fretboardMaterial && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-gray-900">{guitar.fretboardMaterial}</span>
                        </div>
                      )}
                      ...
                      {guitar.pickupConfiguration && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-gray-900">{guitar.pickupConfiguration}</span>
                        </div>
                      )}
                      ...
                      {guitar.scaleLength && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-gray-900">{guitar.scaleLength}</span>
                        </div>
                      )}

                      <div className="flex justify-between">
                        <span className="text-gray-600">Number of Frets</span>
                        <span className="font-medium text-gray-900">{guitar.numberOfFrets}</span>
                      </div>

                      {guitar.countryOfOrigin && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Made In</span>
                          <span className="font-medium text-gray-900">{guitar.countryOfOrigin}</span>
                        </div>
                      )}
                    </div>
